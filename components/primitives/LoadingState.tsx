 ...
 *   Surfer — the Drive loader paired with caller-owned media
 *
...
export default function LoadingState({
  label,
  variant = "Drive",
  /** Optional caller-owned media for the Surfer variant. */
  videoSrc,
}: {
  label?: string;
  variant?: string;
  ...
  const resolvedLabel = label ?? (surfer ? "Media task running" : "Churning");
