...
type LocalIconProps = { size?: number; className?: string };

function LocalIcon({ size = 18, className = "", variant = "circle" }: LocalIconProps & { variant?: string }) {
  const paths: Record<string, ReactNode> = {
    home: <><path d="M3 11.5 12 4l9 7.5"/><path d="M5.5 10v10h13V10"/></>,
    user: <><circle cx="9" cy="8" r="3"/><path d="M3.5 20c.5-4 2.4-6 5.5-6s5 2 5.5 6M18 8v6M15 11h6"/></>,
    edit: <><path d="M4 20l4.2-1 10.7-10.7a2 2 0 0 0-2.8-2.8L5.4 16.2z"/><path d="M14.7 6.9l2.8 2.8"/></>,
    search: <><circle cx="10.5" cy="10.5" r="6.5"/><path d="m16 16 5 5"/></>,
    plus: <path d="M12 5v14M5 12h14"/>,
    close: <path d="m6 6 12 12M18 6 6 18"/>,
    check: <path d="m5 12 4 4L19 6"/>,
    chevron: <path d="m7 10 5 5 5-5"/>,
    sidebar: <><path d="M4 5h16v14H4z"/><path d="M9 5v14m5-10-3 3 3 3"/></>,
    ...
    circle: <><circle cx="12" cy="12" r="8"/><path d="M9 8h6v8H9z"/></>,
  };
  return <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden>{paths[variant] ?? paths.circle}</svg>;
}

const IconArrowBoxLeft = (props: LocalIconProps) => <LocalIcon {...props} variant="signout" />;
const IconCheckmark1Small = (props: LocalIconProps) => <LocalIcon {...props} variant="check" />;
const IconChevronDownSmall = (props: LocalIconProps) => <LocalIcon {...props} variant="chevron" />;
const IconCrossSmall = (props: LocalIconProps) => <LocalIcon {...props} variant="close" />;
const IconEditBig = (props: LocalIconProps) => <LocalIcon {...props} variant="edit" />;
const IconHome = (props: LocalIconProps) => <LocalIcon {...props} variant="home" />;
const IconMagnifyingGlass = (props: LocalIconProps) => <LocalIcon {...props} variant="search" />;
const IconPlusMedium = (props: LocalIconProps) => <LocalIcon {...props} variant="plus" />;
const IconPopsicle2 = (props: LocalIconProps) => <LocalIcon {...props} />;
const IconSettingsGear1 = (props: LocalIconProps) => <LocalIcon {...props} variant="settings" />;
const IconSidebarLeftArrow = (props: LocalIconProps) => <LocalIcon {...props} variant="sidebar" />;
const IconUserAdd = (props: LocalIconProps) => <LocalIcon {...props} variant="user" />;
